...
interface ScenarioDEXInterface extends ethers.utils.Interface {
  functions: {
    "USD_DECIMALS()": FunctionFragment;
    "exchangeRate(address)": FunctionFragment;
    "swap(address,address,uint256)": FunctionFragment;
    "updateExchangeRate(address,uint256)": FunctionFragment;
  };
...
export class ScenarioDEX extends BaseContract {
  ...
  interface: ScenarioDEXInterface;

  functions: {
    USD_DECIMALS(overrides?: CallOverrides): Promise<[BigNumber]>;

    exchangeRate(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
