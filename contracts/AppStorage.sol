...
struct Strategy {
  ...
  //  @param sellAt The target price at which to sell. if sell is set. Otherwise it remains 0
  uint256 sellAt;
  // @param floorAt The floor price at which floor occurs. if floor is set. Otherwise it remains 0
  uint256 floorAt;
  // @param buyAt The target price at which to buy. if buy is set. Otherwise it remains 0
  uint256 buyAt;
